...
export class MatchdayTipsTopTeamExtractorLast2 extends MatchdayTipsTopTeamExtractor {
  public extractGamesPlayed(player: Player): Game[] {
    return new ArrayStream<Game>(player.games).orderBy('matchday', 'dsc').take(2).collect();
  }
}
