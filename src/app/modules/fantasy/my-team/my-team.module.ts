...
import { MyTeamStateResolver } from './routing/my-team-state.resolver';
...
@NgModule({
  ...
  providers: [MyTeamTilesDisplaySettingsService, MyTeamPlayersFitlersService, MyTeamStateResolver]
})
