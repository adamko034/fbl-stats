...
import { FixturesDifficultyDeterminer } from './fixtures-difficulty-determiner';

export class FixturesDifficultyByForm extends FixturesDifficultyDeterminer {
  ...
  constructor(
    includeVenueCalculation: boolean,
    private lastGamesCount: number,
    fixtureDifficultyColorsService: FixtureDifficultyColorsService
  ) {
    super(includeVenueCalculation, fixtureDifficultyColorsService);
