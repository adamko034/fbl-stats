...
export class FixturesDifficultyByRank extends FixturesDifficultyDeterminer {
  private numeralsPipe: NumeralsPipe;

  constructor(includeVenueCalculation: boolean, fixtureDifficultyColorsService: FixtureDifficultyColorsService) {
