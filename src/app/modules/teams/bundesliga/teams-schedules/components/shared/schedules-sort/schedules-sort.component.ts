...
@Component({
  ...
  selector: 'app-schedules-sort',
  templateUrl: './schedules-sort.component.html',
  styleUrls: ['./schedules-sort.component.scss']
})
export class SchedulesSortComponent implements OnInit {
